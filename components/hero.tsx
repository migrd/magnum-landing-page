      ...
      <div className="relative max-w-6xl mx-auto px-6 sm:px-6">
        ...
        <div className="pt-32 pb-16 md:pt-52 md:pb-32">
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h1 className="h1 mb-8 bg-clip-text text-transparent bg-gradient-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-4" data-aos="fade-down">Marketing Digital que <span className="text-blue-300">Funciona</span> por um Preço <span className="text-blue-300">Justo</span></h1>
            <p className="text-lg text-slate-300 mb-8" data-aos="fade-down" data-aos-delay="200">Sabemos que os métodos de marketing tradicionais não pagam as contas, então venha conhecer o método Magnum de fazer marketing.</p>
            <div className="max-w-xs mx-auto sm:max-w-none sm:inline-flex sm:justify-center space-y-4 sm:space-y-0 sm:space-x-4" data-aos="fade-down" data-aos-delay="400">
              ...
              <div>
                <a className="btn text-slate-200 hover:text-white bg-slate-900 bg-opacity-25 hover:bg-opacity-30 w-full transition duration-150 ease-in-out" href="#feature">
                  ...
                  <span>Conheça o método Magnum</span>
                </a>
              </div>
            </div>
